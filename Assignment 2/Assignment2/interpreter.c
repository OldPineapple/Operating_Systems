...
int exec(char *file1, char *file2, char *file3) {
    ...
    if (f1 != NULL && f2 != NULL && f3 != NULL) {
        ...
        else if(strcmp(file2, file3) == 0) {
            printf("Error: Script <%s> already loaded\n", file2);
            return 1;
        }
        else if (strcmp(file1, file3) == 0) {
            printf("Error: Script <%s> already loaded\n", file1);
            return 1;
        }
        else {
    ...
    else if ((file1 != NULL && f1 == NULL) || (file2 != NULL && f2 == NULL) || (file3 != NULL && f3 == NULL)) {
...
int interpret(char *raw_input)
{
    ...
    if (strcmp(tokens[0], "exec") == 0)
    {
        ...
        free(tokens);
        return exec(tokens[1], tokens[2], tokens[3]);
    }
